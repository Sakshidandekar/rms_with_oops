...
tk.Label(window,text='Moonlight Cafe',font=('Helvetica',19)).place(x=125,y=50)
tk.Button(window,text='Start',width=18,command=moonlight_cafe).place(x=40,y=150)
